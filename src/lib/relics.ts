...
export const STATIC_RELICS: Relic[] = [
  {
    ...
    era: "Lith",
    description:
      "A warm, pulsing amber gemstone that holds the first light of day.",
  ...
  },
  {
    ...
    era: "Lith",
    description:
      "A weather-worn brass key encrusted with sea salt and barnacles.",
  ...
  },
  {
    ...
    era: "Meso",
    description:
      "A humming mechanical core that vibrates with steady clockwork precision.",
  ...
  },
  {
    ...
    era: "Meso",
    description:
      "A beautifully crafted miniature steam engine that spins silently.",
  ...
  },
  {
    ...
    era: "Neo",
    description:
      "A glowing neon sigil projecting holographic digital encryption.",
  ...
  },
  {
    ...
    era: "Neo",
    description:
      "Advanced cybernetic headgear displaying real-time tactical overlays.",
    abilities: "Transits camera to the Virtual Arena Grandstand.",
    howToAchieve:
      "Achieved by submitting 20 correct solutions in the Virtual Arena.",
    target_x: 50.0,
    target_y: 30.0,
    target_z: -180.0,
  },
  {
    ...
    era: "Axi",
    description:
      "A stellar prism that refracts light into pure cosmic energy lines.",
  ...
  },
  {
    ...
    era: "Axi",
    description:
      "An intricate gold pocketwatch that moves slightly out of sync with time.",
  ...
  },
  {
    ...
    era: "Requiem",
    description:
      "A heavy, dark artifact humming with pure, unstable void energy.",
  ...
  },
  {
    ...
    era: "Requiem",
    description:
      "An ancient compass pointing to uncharted lands beyond the horizon.",
