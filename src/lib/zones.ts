...
export const ACHIEVEMENT_ITEMS: Record<
  string,
  { achievement: string; label: string }
> = {
  flag: {
    achievement: "first_push",
    label: "First Blood (Solve 1 LeetCode problem)",
  },
  custom_color: {
    achievement: "committed",
    label: "Problem Solver (Solve 100 LeetCode problems)",
  },
  neon_trim: {
    achievement: "grinder",
    label: "Grinder (Solve 500 LeetCode problems)",
  },
  antenna_array: {
    achievement: "builder",
    label: "Easy Breezy (Solve 100 Easy LeetCode problems)",
  },
  rooftop_garden: {
    achievement: "architect",
    label: "Medium Master (Solve 250 Medium LeetCode problems)",
  },
  helipad: {
    achievement: "recruiter",
    label: "Recruiter (Refer 10 developers to LeetCode City)",
  },
  white_rabbit: {
    achievement: "white_rabbit",
    label: "Found the White Rabbit",
  },
  scouting_satellite: {
    achievement: "leetcode_questions",
    label: "Solve 10 Medium or 5 Hard LeetCode Questions",
  },
};
...
export const RAID_VEHICLE_ITEMS = [
  "raid_helicopter",
  "raid_drone",
  "raid_rocket",
  "raid_b2_bomber",
...
export const RAID_BOOST_ITEMS = [
  "raid_boost_small",
  "raid_boost_medium",
  "raid_boost_large",
];
export const RAID_CONSUMABLE_ITEMS = [
  "anti_missile_system",
  "anti_tank_mines",
  "emp_shield",
  "stealth_cloak",
