    ...
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        <ProblemCard
          ...
          body="LeetCode profiles are flat pages with a green square grid. No depth, no personality, no reason to come back."
        />
        <ProblemCard
          icon="..."
  ...
  return (
    <div className="flex w-full max-w-4xl flex-col gap-8">
      ...
      <p className="text-sm leading-relaxed text-muted normal-case sm:text-base">
        ...
        and community platforms are underserved. LeetCode has no social layer
        beyond follow/star.
      </p>
    </div>
  );
      ...
      <div className="border-[3px] border-border bg-bg-raised p-6 sm:p-8">
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="text-2xl text-cream sm:text-3xl">ixotic</p>
  ...
  return (
    <div className="flex w-full max-w-4xl flex-col items-center justify-center gap-10 text-center">
      ...
      <p className="max-w-2xl text-lg leading-relaxed text-muted normal-case sm:text-2xl">
        Building the social layer LeetCode never made. A living city where
