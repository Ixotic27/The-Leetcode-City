...
export const metadata: Metadata = {
  title: "Terms of Service - LeetCode City",
  description: "Terms of Service for LeetCode City.",
};
      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="mt-8 flex flex-col gap-5">
          ...
          <Section n={7} title="Limitation of Liability">
            <p>
              To the maximum extent permitted by law, Ixotic and LeetCode City
  ...
  return (
    <div className="border-[3px] border-border bg-bg-raised p-5 sm:p-6">
      <p className="text-sm text-cream">
        <span style={{ color: "#ffa116" }}>{String(n).padStart(2, "0")}.</span>{" "}
        {title}
      </p>
