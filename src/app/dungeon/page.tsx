...
function playRetroSound(
  type: "hit" | "heal" | "defend" | "victory" | "defeat" | "special",
  enabled: boolean,
) {
...
function BossGraphic({
  ...
  const flashClass = flashing
    ? "brightness-125 saturate-125 contrast-110 scale-105"
    : "";
  ...
  if (type === "goblin") {
    return (
      <svg
        viewBox="0 0 100 100"
        className={`w-28 h-28 transition-all duration-150 ${flashClass}`}
      >
        <defs>
        ...
        <path
          d="M30 75 L70 75 L65 72 L35 72 Z"
          fill="#2a2a30"
          stroke="#00b8a3"
          strokeWidth="1.5"
        />
        {/* Main Head */}
        <path
          d="M25 40 L35 30 L65 30 L75 40 L70 70 L30 70 Z"
          fill="url(#goblinGrad)"
          stroke="#00b8a3"
          strokeWidth="2"
        />
        {/* Pointy Ears */}
        <path
          d="M25 42 L5 25 L28 48 Z"
          fill="#008c7c"
          stroke="#004d45"
          strokeWidth="1.5"
        />
        <path
          d="M75 42 L95 25 L72 48 Z"
          fill="#008c7c"
          stroke="#004d45"
          strokeWidth="1.5"
        />
        {/* Visor */}
        <path
          d="M28 45 L72 45 L68 53 L32 53 Z"
          fill="#0d0d0f"
          stroke="#ffa116"
          strokeWidth="1.5"
        />
        ...
        {/* Metal Jaw plates */}
        <path
          d="M35 60 L45 62 L55 62 L65 60 L60 67 L40 67 Z"
          fill="#2a2a30"
          stroke="#3a3a44"
          strokeWidth="1.5"
        />
  ...
  if (type === "orc") {
    return (
      ...
      >
        ...
        {/* Heavy shoulders */}
        <path
          d="M10 75 L30 65 L70 65 L90 75 L85 85 L15 85 Z"
          fill="#2a2a30"
          stroke="#3a3a44"
          strokeWidth="2"
        />
        ...
        {/* Head Armor Block */}
        <path
          d="M22 30 L78 30 L74 60 L26 60 Z"
          fill="url(#orcGrad)"
          stroke="#cc7100"
          strokeWidth="2.5"
        />
        {/* Iron visor mask */}
        <path
          d="M20 38 L80 38 L72 50 L50 56 L28 50 Z"
          fill="#1c1c20"
          stroke="#8c8c9c"
          strokeWidth="2"
        />
        ...
        {/* Massive tusks */}
        <path
          d="M26 60 L18 52 L26 50 Z"
          fill="#d4cfc4"
          stroke="#8c8c9c"
          strokeWidth="1"
        />
        <path
          d="M74 60 L82 52 L74 50 Z"
          fill="#d4cfc4"
          stroke="#8c8c9c"
          strokeWidth="1"
        />
  ...
  return (
    ...
    >
      ...
      {/* Wings */}
      <path
        d="M12 40 L5 20 L25 25 L12 40 L28 42 Z"
        fill="#660014"
        stroke="#ff2d55"
        strokeWidth="1.5"
      />
      <path
        d="M88 40 L95 20 L75 25 L88 40 L72 42 Z"
        fill="#660014"
        stroke="#ff2d55"
        strokeWidth="1.5"
      />
      {/* Neck scales */}
      <path
        d="M42 62 L58 62 L54 85 L46 85 Z"
        fill="#cc0029"
        stroke="#ff2d55"
        strokeWidth="1.5"
      />
      {/* Main Head */}
      <path
        d="M22 35 L50 15 L78 35 L72 65 L50 80 L28 65 Z"
        fill="url(#dragonBody)"
        stroke="#ff2d55"
        strokeWidth="2"
      />
...
function PlayerGraphic({ flashing }: { flashing: boolean }) {
  ...
  return (
    ...
    >
      ...
      {/* Desk pedestal */}
      <path
        d="M20 82 L80 82 L85 92 L15 92 Z"
        fill="#2a2a30"
        stroke="#3a3a44"
        strokeWidth="1.5"
      />
...
export default function DungeonPage() {
  ...
  useEffect(() => {
    ...
    const fetchChallenge = async () => {
      try {
          ...
          if (arenaRes.ok) {
            ...
            const matchingCh = arenaData.challenges?.find(
              (c: any) =>
                ...
                resolvedProblem.difficulty.toLowerCase(),
            );
            if (matchingCh) {
        ...
        console.warn(
          "LeetCode daily API offline, falling back to local simulation database.",
        );
        setIsOffline(true);
        const randomMock =
          MOCK_PROBLEMS[Math.floor(Math.random() * MOCK_PROBLEMS.length)];
    ...
    setBattleLogs([
      {
        timestamp: new Date().toLocaleTimeString(),
        type: "system",
        message: "You descend into the coding dungeon...",
      },
      {
        timestamp: new Date().toLocaleTimeString(),
        type: "warning",
        message: `A wild ${stats.name} (${problem.difficulty} challenge) blocks your path!`,
      },
      {
        timestamp: new Date().toLocaleTimeString(),
        type: "boss",
        message: 'Boss: "Let\'s see if you can solve this today."',
      },
      {
        timestamp: new Date().toLocaleTimeString(),
        type: "system",
        message: "The battle begins! Choose your command sequence.",
      },
    ]);
  ...
  const handleAction = (action: "attack" | "defend" | "heal" | "special") => {
    ...
    if (action === "attack") {
      ...
      addLog(
        `You compile code solutions, dealing ${playerDamage} damage to ${bossStats.name}.`,
        "attack",
      );
      setBattleStats((prev) => ({
        ...prev,
        damageDealt: prev.damageDealt + playerDamage,
      ...
      addLog(
        `Critical attack! You deployed a git commit, dealing ${playerDamage} damage to ${bossStats.name}!`,
        "special",
      );
      setBattleStats((prev) => ({
        ...prev,
      ...
      addLog(
        `You refactored files and patched your workspace, recovering ${healAmount} health.`,
        "heal",
      );
      setBattleStats((prev) => ({
        ...prev,
        healsUsed: prev.healsUsed + 1,
        turnsPlayed: prev.turnsPlayed + 1,
      }));
      ...
      addLog(
        `You implemented code comments, shielding yourself from incoming attacks.`,
        "defend",
      );
      setBattleStats((prev) => ({
        ...prev,
    ...
    setTimeout(() => {
      ...
      const bossAbility =
        bossDamage > bossStats.baseDmg + 2
          ? "Critical Error: Stack Overflow"
          : "Compilation Warning: Syntax Error";

      addLog(
        `${bossStats.name} executes [${bossAbility}], dealing ${finalBossDamage} damage.`,
        "boss",
      );
      setBattleStats((prev) => ({
        ...prev,
        damageTaken: prev.damageTaken + finalBossDamage,
      }));
      playRetroSound("hit", soundEnabled);
  ...
  const triggerVictory = () => {
    ...
    addLog(
      `Victory! The ${BOSS_MAP[problem?.difficulty ?? "Medium"].name} has been defeated!`,
      "victory",
    );
    addLog(
      "You have resolved today's challenge. Rewards sync complete.",
      "gift",
    );
  ...
  return (
    <main className="min-h-screen bg-bg font-pixel text-warm pb-16 relative overflow-hidden">
      ...
      <div
        className={`mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 relative z-10 ${screenShaking ? "screen-shake" : ""}`}
      >
        {/* Navigation & Header */}
        <div className="flex flex-col border-b-[3px] border-border pb-6 mb-8 md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-dim text-[10px] uppercase">
              SIMULATOR PORTAL v2.5.0
            </span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <DungeonIcon
                name={soundEnabled ? "sound-on" : "sound-off"}
        ...
        {loading && (
          <div className="flex h-96 flex-col items-center justify-center border-[3px] border-border bg-bg-raised p-8 text-center shadow-lg relative overflow-hidden">
            <div className="relative mb-6">
              <svg
                viewBox="0 0 100 100"
                className="w-16 h-16 animate-spin text-[#ffa116]"
              ...
              >
                ...
                />
                <polygon
                  points="50,25 55,45 75,50 55,55 50,75 45,55 25,50 45,45"
                  fill="currentColor"
                  opacity="0.7"
                />
              </svg>
            </div>
            <p className="text-sm font-bold text-cream tracking-widest blink-dot">
              SYNCHRONIZING MATRIX...
            </p>
            <p className="text-[10px] text-muted mt-2 normal-case font-mono">
              Fetching latest challenge data from LeetCode mainframe
            </p>
          </div>
        )}
        ...
        {error && !problem && (
          <div className="flex h-96 flex-col items-center justify-center border-[3px] border-rose-950 bg-rose-950/10 p-8 text-center shadow-lg relative">
            ...
            <h2 className="text-sm text-rose-400 mb-2 font-bold tracking-wider">
              PORTAL ERROR
            </h2>
            <p className="text-[10px] text-muted max-w-sm mb-6 leading-relaxed">
              Unable to reach the remote daily API gateway. Check your
              connection or launch local simulation.
            </p>
            <button
              onClick={() => {
                setError(false);
                ...
                const randomMock =
                  MOCK_PROBLEMS[
                    Math.floor(Math.random() * MOCK_PROBLEMS.length)
                  ];
                setProblem(randomMock);
                setLoading(false);
              }}
          ...
          <>
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 items-stretch">
                ...
                <div className="border-[3px] border-border bg-bg-raised p-6 pixel-shadow relative flex flex-col gap-6 flex-1">
                  ...
                  {gameState === "intro" && (
                    <div className="flex flex-col items-center justify-center py-12 text-center relative z-20">
                      ...
                      <span className="text-[10px] text-muted block mb-1 font-mono tracking-widest uppercase">
                        DUNGEON GUARDIAN SYSTEM
                      </span>
                      <h2
                      ...
                      <p className="max-w-md text-xs text-muted mb-8 leading-relaxed normal-case">
                        Deploy algorithmic optimizations to tackle the
                        challenge. Run tests to recover your health, refactor
                        files to block attacks, and commit code to deliver
                        critical payloads.
                      </p>
                    ...
                    <div className="flex flex-col relative z-20">
                        ...
                        <div className="border-[3px] border-border bg-bg p-4 relative">
                          ...
                          <div className="flex items-center justify-between mt-2 text-[9px] text-dim">
                            ...
                            <span className="font-bold text-[#00b8a3]">
                              ...
                              {((playerHp / playerMaxHp) * 100).toFixed(0)}%]
                            </span>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="text-center relative">
                          {gameState === "victory" ? (
                            <div className="w-28 h-28 flex flex-col items-center justify-center select-none animate-pulse">
                              ...
                              />
                              <span className="text-[9px] text-rose-500 mt-2 tracking-widest font-mono font-bold">
                                DAEMON_CRASHED
                              </span>
                            </div>
                          ) : (
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                          ...
                          <button
                            disabled={
                              gameState !== "battle" || specialCooldown > 0
                            }
                          ...
                          >
                            ...
                            />
                            COMMIT{" "}
                            {specialCooldown > 0 ? `(${specialCooldown})` : ""}
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="border-[3px] border-border bg-bg p-5 h-56 rounded-lg overflow-y-auto font-mono text-[11px] leading-relaxed scrollbar-thin">
                        {battleLogs.map((log, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className={`mb-2 flex items-start gap-2.5 ${textColor}`}
                            >
              ...
              <div className="lg:col-span-4 flex flex-col gap-6">
                ...
                <div className="border-[3px] border-border bg-bg-raised p-6 pixel-shadow relative flex-1 flex flex-col">
                  <span className="text-[10px] text-muted block mb-1 font-mono tracking-wider">
                    MISSION BRIEFING
                  </span>
                  <h3 className="text-xs text-cream mb-4 font-bold">
                    DAILY CHALLENGE MATRICES
                  </h3>

                  <div className="mb-4">
                    <span className="text-[10px] text-muted block mb-2 font-mono">
                      TARGET HOSTILE DAEMON:
                    </span>
                    <div className="flex items-center gap-3 bg-bg border-2 border-border p-3">
                      ...
                      <div>
                        <span className="text-[11px] text-cream font-bold block">
                          {bossInfo.name}
                        </span>
                        <span className="text-[9px] text-muted block mt-0.5">
                          MATRIX UNIT: {bossInfo.maxHp} HP
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="bg-bg border-2 border-border p-4">
                      <p className="text-[11px] text-cream leading-relaxed normal-case font-bold">
                        {problem.title}
                      </p>
                      <span className="text-[9px] text-muted block mt-1 normal-case font-mono">
                  ...
                  <div className="mb-4 flex items-center justify-between bg-bg border-2 border-border p-3">
                    <div>
                      <span className="text-[10px] text-muted block mb-1 font-mono">
                        DIFFICULTY:
                      </span>
                      <span
                        ...
                        style={{
                          borderColor: `${bossInfo.color}40`,
                          color: bossInfo.color,
                          backgroundColor: `${bossInfo.color}0d`,
                        }}
                      >
                        {problem.difficulty}
                      </span>
                    ...
                    <div>
                      <span className="text-[10px] text-muted block mb-1 text-right font-mono">
                        XP_SYNC:
                      </span>
                    ...
                    {challengeId ? (
                      <div className="flex flex-col gap-3">
                        <p className="text-[10px] text-muted normal-case mb-2 leading-relaxed">
                          Objective active in extension database. Deploy to VS
                          Code or Antigravity IDE to solve this challenge:
                        </p>
                      ...
                      <div>
                        <p className="text-[10px] text-muted normal-case mb-4 leading-relaxed">
                          Connecting to the remote mainframe resolves this
                          objective. Access the direct coding console on
                          LeetCode to submit your solution.
                        </p>
                ...
                {gameState !== "intro" && (
                  <div className="border-[3px] border-border bg-bg-raised p-6 pixel-shadow relative overflow-hidden">
                    ...
                    <h3 className="text-xs text-cream mb-4 font-bold font-mono">
                      SESSION_RECORD
                    </h3>
            ...
            <div className="border-[3px] border-border bg-bg-raised p-6 pixel-shadow mt-8">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="text-xs text-cream font-bold">
                  RULES OF THE CRYPT
                </h4>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="text-[10px] text-muted normal-case leading-relaxed flex gap-2">
                  ...
                  <span>
                    The Daily Challenge rotates automatically every midnight
                    UTC.
                  </span>
                </div>
                <div className="text-[10px] text-muted normal-case leading-relaxed flex gap-2">
                  ...
                  <span>
                    Solving the boss problem awards custom XP and Arena rating
                    updates.
                  </span>
                </div>
                <div className="text-[10px] text-muted normal-case leading-relaxed flex gap-2">
                  ...
                  <span>
                    Defeating higher tier daemons (Medium/Hard) drops higher
                    level credentials and badges.
                  </span>
                </div>
                <div className="text-[10px] text-muted normal-case leading-relaxed flex gap-2">
                  <span className="text-[#ffa116] font-bold shrink-0">04.</span>
                  <span>
                    Solving solutions syncs with the city database within
