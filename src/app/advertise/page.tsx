...
export const metadata: Metadata = {
  ...
  description:
    "Reach 9,000+ LeetCode developers. Planes, blimps, and billboards in a 3D city. 1%+ CTR (2x industry avg). From $9/week.",
  openGraph: {
    title: "Advertise on LeetCode City",
    description:
      "Reach 9,000+ LeetCode developers. Planes, blimps, and billboards in a 3D city. 1%+ CTR (2x industry avg). From $9/week.",
...
export default async function AdvertisePage() {
  ...
  const statCards = [
    ...
    { value: `${formatK(devCount)}+`, label: "LeetCode developers" },
  ];
      ...
      <div className="mx-auto max-w-3xl px-4 pt-6 pb-12">
        ...
        <div className="mt-8 border-[3px] border-border p-5 sm:p-6">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            {[
              "Verified LeetCode developers, not bots",
        ...
        {ctr > 0.5 && (
          <div className="mt-8 border-[3px] border-border p-5 sm:p-6">
            <p className="text-base text-cream">
              LeetCode City vs traditional ads
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  a: "100% LeetCode developers. Software engineers, CTOs, indie hackers, open source maintainers. Every building is a real LeetCode profile with real contribution data. No bots, no fake traffic.",
                },
                {
                ...
                },
                {
                  ...
                  a: "Refunds are evaluated on a case-by-case basis. Contact ixotic@gmail.com within the first 24 hours if there's an issue with your ad.",
                },
              ].map((item) => (
          ...
          <div className="mt-14 text-center">
            ...
            <p className="mt-4 text-xs text-muted normal-case">
              ...
              <a
                ...
                className="transition-colors hover:text-cream"
                style={{ color: "#d97706" }} // amber-600 to match previous styling
              >
                Ixotic
              </a>
            </p>
