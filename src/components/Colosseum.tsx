  ...
  useFrame(({ clock }) => {
    if (groupRef.current) {
      ...
      groupRef.current.position.y =
        230 + Math.sin(clock.getElapsedTime() * 1.5) * 10;
    }
  });
    ...
    >
      ...
      <group position={[-85, 0, 0]}>
        ...
        {[-30, -10, 10, 30].map((xOffset) =>
          [40, 70, 100, 130, 160].map((yHeight) => (
            <mesh
              key={`l-win-low-${xOffset}-${yHeight}`}
              position={[xOffset, yHeight, 40.5]}
            >
        ...
        {[-15, 15].map((xOffset) =>
          [210, 250, 290, 330, 370, 410].map((yHeight) => (
            <mesh
              key={`l-win-high-${xOffset}-${yHeight}`}
              position={[xOffset, yHeight, 30.5]}
            >
        ...
        {[-28, 28].map((xOffset) =>
          [-28, 28].map((zOffset) => (
            <mesh
              key={`l-crown-${xOffset}-${zOffset}`}
              position={[xOffset, 452, zOffset]}
              castShadow
            >
      ...
      <group position={[85, 0, 0]}>
        ...
        {[-15, 15].map((xOffset) =>
          [210, 250, 290, 330, 370, 410].map((yHeight) => (
            <mesh
              key={`r-win-high-${xOffset}-${yHeight}`}
              position={[xOffset, yHeight, 30.5]}
            >
              <boxGeometry args={[12, 28, 1]} />
              <meshStandardMaterial
