...
insert into sky_ads (id, brand, text, description, color, bg_color, link, vehicle, priority) values
  ('leetcodecity', 'LeetCode City', 'THELEETCODECITY.TECH ★ YOUR CODE, YOUR CITY ★ THELEETCODECITY.TECH', 'A city built from LeetCode contributions. Search your username and find your building among thousands of developers.', '#f8d880', '#1a1018', 'https://theleetcodecity.tech', 'plane', 100),
  ...
  ('advertise', 'Sky Ads', 'ADD YOUR AD HERE', 'Want your brand flying over LeetCode City? Planes, blimps, your colors. Get in touch!', '#f8d880', '#1a1018', 'mailto:samuelrizzondev@gmail.com?subject=LeetCode%20City%20Sky%20Ad', 'plane', 10);
