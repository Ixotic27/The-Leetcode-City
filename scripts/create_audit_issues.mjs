...
const issues = [
  ...
  {
    title:
      "Auto-merge action requires approval but AI reviewer can't approve without API key",
  ...
  {
    title:
      "Docker package build fails — Next.js build requires environment variables at build time",
  ...
  {
    title:
      "LeetCode seeder only pulled 84 pages (~2k users) — pipeline stalled, not reaching 10k+ target",
  ...
  {
    title:
      "Hourly fetcher only refreshes existing users — no new users are ever discovered",
  ...
  {
    title:
      "Seed script uses many fake/non-existent LeetCode usernames that get skipped",
  ...
  {
    title:
      "Searching for a LeetCode username only shows the building if it already exists — no visual feedback for new adds",
  ...
  {
    title:
      "Ground vehicles (Tank) float in the air instead of driving on the ground during raids",
  ...
  {
    title:
      "Add explosion and impact particle effects when raid projectiles hit the target building",
  ...
  {
    title:
      "page.tsx is 5,000+ lines — needs to be split into smaller components",
  ...
  {
    title:
      "Inconsistent error handling — catch blocks use mix of console.log, console.warn, console.error",
  ...
  {
    title:
      "Rate limiter uses hardcoded values — should be configurable via environment variables",
  ...
  {
    title:
      "LeetCode GraphQL query fetches calendar data for all years since 2015 — causes large payloads and potential rejections",
  ...
  {
    title:
      "Add a cron-based GitHub Action to run the LeetCode seeder automatically",
  ...
  {
    title:
      "Missing loading skeleton/shimmer for building cards and leaderboard",
