...
async function run() {
  console.log(
    "Posting additional landmark redirection and security issues to GitHub...",
  );

  const issues = [
    {
      title:
        "💡 Feature: Link DungeonPortal Landmark Click to a Daily Coding Challenge Dungeon Modal",
    ...
    {
      title:
        "💡 Feature: Link SkyTemple Landmark Click to a Zen Coding Mode Focus Timer",
    ...
    {
      title:
        "💡 Feature: Link CodeForge Landmark Click to an IDE/Compiler Customization Modal",
