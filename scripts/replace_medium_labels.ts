...
async function updateIssueLabels(issueNumber: number, labels: string[]) {
  ...
  if (res.status === 200) {
    console.log(
      `Successfully updated labels for issue #${issueNumber} to:`,
      labels,
    );
  } else {
    console.error(
