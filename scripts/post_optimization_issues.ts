...
async function run() {
  ...
  const issues = [
    {
      title:
        "⚡ Performance: Optimize Loading Screen Asset Caching and Pre-fetching",
    ...
    {
      title:
        "⚡ Performance: Reduce Lag via Level of Detail (LOD) for Distant Voxel Buildings",
    ...
    {
      title:
        "⚡ Performance: Handle WebGL Context Loss to Stabilize the 3D Render Loop",
