...
async function main() {
  ...
  if (res.ok) {
    ...
    console.log(
      "'enforce-branch' and 'review' removed — their workflows still run",
    );
    console.log(
      "and auto-close bad PRs, but they no longer block merging for valid PRs.",
    );
  } else {
