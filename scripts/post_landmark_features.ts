...
async function run() {
  ...
  const issues = [
    {
      title:
        "💡 Feature: Link CyberStation Landmark Click to the Multiplayer Arcade Room",
    ...
    {
      title:
        "💡 Feature: Link ChronoTower Landmark Click to Coding History & Milestones",
    ...
    {
      title:
        "💡 Feature: Link SolanaBuilding click to Solana Wallet & Contract Showcase",
