export const DEFAULT_API_URL = "https://hackoholic4.live";
...
export const QUEUE_STORAGE_KEY = "leetcodecity.pendingHeartbeats";
export const ACTIVE_SECONDS_KEY = "leetcodecity.activeSeconds";
